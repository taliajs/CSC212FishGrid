...
public class FishGame {
	...
	public FishGame(int w, int h) {
		...
		// Generate some number of food
		int numfood = 5;

		// (lab) Make the number of rocks into a constant, so it's easier to find & change.
	...
	private void wanderMissingFish() {
		...
		for (Fish lost : missing) {
			...
			} else { // If it's not a scared fish, 30% of the time it moves randomly.
